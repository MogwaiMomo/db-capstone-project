...
CREATE TABLE `employees` (
  ...
  KEY `fk_Employees_EmployeeRoles1_idx` (`EmployeeRoles_EmployeeRoleID`),
  CONSTRAINT `fk_Employees_EmployeeRoles1` FOREIGN KEY (`EmployeeRoles_EmployeeRoleID`) REFERENCES `employeeroles` (`EmployeeRoleID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `locationcities`
--

DROP TABLE IF EXISTS `locationcities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2024-03-31 21:05:52
